srcdir = /sh-1.4.4/php-5.5.7/ext/snowflake
builddir = /sh-1.4.4/php-5.5.7/ext/snowflake
top_srcdir = /sh-1.4.4/php-5.5.7/ext/snowflake
top_builddir = /sh-1.4.4/php-5.5.7/ext/snowflake
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
shared_objects_snowflake = snowflake.lo snowflake_lib.lo
PHP_PECL_EXTENSION = snowflake
PHP_MODULES = $(phplibdir)/snowflake.la
PHP_ZEND_EX =
...
prefix = /alidata/server/php
phplibdir = /sh-1.4.4/php-5.5.7/ext/snowflake/modules
phpincludedir = /alidata/server/php/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
PHP_EXECUTABLE = /alidata/server/php/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/alidata/server/php/include/php -I/alidata/server/php/include/php/main -I/alidata/server/php/include/php/TSRM -I/alidata/server/php/include/php/Zend -I/alidata/server/php/include/php/ext -I/alidata/server/php/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
